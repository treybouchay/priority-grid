...
function reflectionPersonaMarkSvg(kind) {
  ...
  const marks = {
    ...
    morning: `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        <path class="rpm-sunrise-arc" d="M6 22c2.8-7 7-10.5 10-10.5S23.2 15 26 22" stroke="#ffdbd2" stroke-width="1.7" stroke-linecap="round"/>
        <circle class="rpm-sunrise-glow" cx="16" cy="14" r="3.2" fill="#ffdbd2" opacity="0.55"/>
      </svg>`,
    "front-loaded": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        ...
        <circle class="rpm-sunrise-glow" cx="16" cy="14" r="3.2" fill="#ffdbd2" opacity="0.6"/>
      </svg>`,
    closing: `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        <circle class="rpm-dusk-moon" cx="17" cy="15" r="5.2" fill="#ffdbd2" opacity="0.85"/>
    ...
    hunter: `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        ...
        <circle class="rpm-target-ring" cx="16" cy="16" r="5.2" stroke="#ffdbd2" stroke-width="1.4"/>
    ...
    "cat-home": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        <g class="rpm-house">
          ...
          <rect x="13.6" y="18.2" width="4.8" height="5.8" rx="0.6" fill="#ffdbd2" opacity="0.85"/>
        </g>
      </svg>`,
    "soft-landing": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
    ...
    "easy-wins": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        ...
        <path class="rpm-tick rpm-tick-3" d="M8 23l2.2 2.2L14.5 21" stroke="#ffdbd2" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        <circle cx="22" cy="12" r="1.4" fill="#ffdbd2" opacity="0.7"/>
        <circle cx="22" cy="18" r="1.4" fill="#0e3030" opacity="0.35"/>
        <circle cx="22" cy="24" r="1.4" fill="#ffdbd2" opacity="0.55"/>
      </svg>`,
    "cat-errands": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        ...
        <circle class="rpm-errand-dot" cx="8" cy="18" r="2.2" fill="#ffdbd2"/>
      </svg>`,
    "cat-work": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        <g class="rpm-briefcase">
          ...
          <path d="M6.5 17h19" stroke="#ffdbd2" stroke-width="1.6"/>
        </g>
      </svg>`,
    "cat-health": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        ...
        <circle class="rpm-health-dot" cx="16" cy="16" r="1.6" fill="#ffdbd2"/>
      </svg>`,
    "cat-personal": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        <circle class="rpm-personal-ring" cx="16" cy="16" r="8.5" stroke="#ffdbd2" stroke-width="1.5" opacity="0.55"/>
        <circle class="rpm-personal-core" cx="16" cy="16" r="3.4" fill="#0e3030" opacity="0.75"/>
      </svg>`,
    "cat-faith": `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        <circle class="rpm-faith-glow" cx="16" cy="16" r="7" fill="#ffdbd2" opacity="0.35"/>
        <path d="M16 8.5v15M16 13.5c2.8 0 4.8 1.4 4.8 3.6S18.8 20.7 16 20.7" stroke="#0e3030" stroke-width="1.6" stroke-linecap="round"/>
      </svg>`,
    fallback: `
      <svg class="reflection-persona-mark-svg" viewBox="0 0 32 32" fill="none" aria-hidden="true">
        <circle class="rpm-fallback-orb" cx="16" cy="16" r="6" fill="#ffdbd2" opacity="0.75"/>
